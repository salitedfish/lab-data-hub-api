...
//        Page<LabdatahubModbusConfig> pageList = labdatahubModbusConfigService.page(page,queryWrapper);
    ...
    public AjaxResult add(@RequestBody LabdatahubModbusConfig labdatahubModbusConfig)
    {
        ...
        ProtocolPointModelSync.afterAdd(labdatahubModbusConfig.getBelongSn(), labdatahubModbusConfig.getBelongType(), labdatahubModbusConfig.getCode(), labdatahubModbusConfig.getName());
        return result;
    }
    ...
    public AjaxResult edit(@RequestBody LabdatahubModbusConfig labdatahubModbusConfig)
    {
        ...
        String oldCode = null;
        if (labdatahubModbusConfig.getId() != null) {
            LabdatahubModbusConfig oldConfig = labdatahubModbusConfigService.getById(labdatahubModbusConfig.getId());
            if (oldConfig != null && StringUtils.isNotBlank(oldConfig.getBelongSn())) {
                ...
                if (oldDevice != null && oldDevice.getComponentId() != null) {
                    ModbusMessageScheduler.removeReadConfig(oldDevice.getComponentId(), oldDevice.getDeviceSn(), oldConfig.getCode());
                }
            }
        }
        ...
        ProtocolPointModelSync.afterEdit(labdatahubModbusConfig.getBelongSn(), labdatahubModbusConfig.getBelongType(), oldCode, labdatahubModbusConfig.getCode(), labdatahubModbusConfig.getName());
        return result;
    }
