 ...
 */
public class MitsubishiMc3eLoopConsumer {
    ...
    private static class ConsumeThread extends Thread {
        ...
        private final MitsubishiMc3eMessageConsumeHandler consumeHandler; // 消费回调
        private final AtomicBoolean isRunning = new AtomicBoolean(true); // 运行标志
        public ConsumeThread(String componentId, MitsubishiMc3eMessageConsumeHandler consumeHandler) {
        ...
        public void run() {
            ...
            while (isRunning.get()) {
                ...
                try {
                    ...
                    MitsubishiMc3eMessage message = queue.take();
                    gotMessage = true;
                    // 调用业务侧的消费逻辑
     ...
     */
    public static void startConsume(String componentId, MitsubishiMc3eMessageConsumeHandler consumeHandler) {
        // 1. 参数校验
